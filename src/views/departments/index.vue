...
function search() {
  ...
  fetchDepartmentsList(params).then((res: any) => {
    ...
    <NCard title="Search Conditions" class="mb-4">
      <NForm :model="searchForm" label-placement="left" label-width="80px" class="search-form">
        <NGrid :cols="4" :x-gap="16">
          <NFormItemGi label="Dept_ID">
            <NInput v-model:value="searchForm.Dept_ID" clearable />
          </NFormItemGi>

          <NFormItemGi label="Dept_Name">
            <NInput v-model:value="searchForm.Dept_Name" clearable />
          </NFormItemGi>
